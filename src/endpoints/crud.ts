...
export interface AxiosCrudEndpoint {
  ...
  patch<T = any, R = AxiosResponse<T>>(url?: string, config?: AxiosRequestConfig): Promise<R>
  post<T = any, R = AxiosResponse<T>>(url?: string, config?: AxiosRequestConfig): Promise<R>
  put<T = any, R = AxiosResponse<T>>(url?: string, config?: AxiosRequestConfig): Promise<R>
